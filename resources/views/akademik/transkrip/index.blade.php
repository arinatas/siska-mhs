                                ...
                                <div class="d-flex flex-wrap">
                                  ...
                                  <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
                                    ...
                                    <div class="d-flex align-items-center">
                                      ...
                                      <!--end::Svg Icon-->
                                      <div class="fs-2 fw-bolder" data-kt-countup="true" data-kt-countup-value="{{ array_sum($sksLulus) }}">0</div>
                                    </div>
                                    <!--end::Number-->
                                    <!--begin::Label-->
                                    <div class="fw-bold fs-6 text-gray-400">SKS Lulus</div>
                                    <!--end::Label-->
                                  </div>
                                  <!--end::Stat-->
                                  <!--begin::Stat-->
                                  <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
                                    ...
                                    <div class="d-flex align-items-center">
                                      ...
                                      <!--end::Svg Icon-->
                                      <div class="fs-2 fw-bolder" data-kt-countup="true" data-kt-countup-value="{{ array_sum($allSks) }}">0</div>
                                    </div>
                                    <!--end::Number-->
                                    <!--begin::Label-->
                                    <div class="fw-bold fs-6 text-gray-400">SKS Diambil</div>
                                    <!--end::Label-->
                                  </div>
                                  <!--end::Stat-->
                                  <!--begin::Stat-->
                                  <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
                                    ...
                                    <div class="d-flex align-items-center">
                                      ...
                                      <!--end::Svg Icon-->
                                      <div class="fs-2 fw-bolder" data-kt-countup="false" data-kt-countup-value="{{ number_format($totalIpk, 2) }}">{{ number_format($totalIpk, 2) }}</div>
                                    </div>
                                    <!--end::Number-->
                                    <!--begin::Label-->
                                    <div class="fw-bold fs-6 text-gray-400">IPK</div>
                                    <!--end::Label-->
                                  </div>
                                  <!--end::Stat-->
                                </div>
                            ...
                            >
                              ...
                              <thead>
                                ...
                                >
                                  ...
                                  <th class="min-w-70px px-3 rounded-end">Bobot</th>
                                </tr>
                              </thead>
                              <!--end::Table head-->
                              <!--begin::Table body-->
