                                ...
                                <div class="d-flex flex-wrap">
                                  ...
                                  <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
                                    ...
                                    <div class="d-flex align-items-center">
                                      ...
                                      <!--end::Svg Icon-->
                                      <div class="fs-2 fw-bolder" data-kt-countup="true" data-kt-countup-value="{{ $totalPoint }}">0</div>
                                    </div>
                                    <!--end::Number-->
                                    <!--begin::Label-->
                                    <div class="fw-bold fs-6 text-gray-400">Total Poin TAK</div>
                                    <!--end::Label-->
                                  </div>
                                  <!--end::Stat-->
                                </div>
                        ...
                        <div class="mb-14">
                          ...
                          <div class="table-responsive">
                            ...
                            >
                              ...
                              <thead>
                                <tr
                                  class="fw-bolder fs-6 text-gray-800 border-0 bg-light"
                                >
                                  <th class="min-w-50px px-3 rounded-start">No</th>
                                  <th class="min-w-250px">Nama Kegiatan</th>
                                  <th class="min-w-50px px-3 rounded-end">Point</th>
                                </tr>
                              </thead>
                              <!--end::Table head-->
                              <!--begin::Table body-->
                              @foreach ($takLists as $key)
                            ...
                            <div class="notice d-flex bg-light-primary rounded border-primary border border-dashed mb-9 p-6">
                              ...
                              <div class="d-flex flex-stack flex-grow-1">
                                <!--begin::Content-->
                                <div class="fw-bold">
                                  <h4 class="text-gray-900 fw-bolder">Belum Ada Poin Transkrip Aktifitas Mahasiswa</h4>
                                  <div class="fs-6 text-gray-700">Hallo <b>{{ auth()->user()->display_name }}</b>, belum ada transkrip nilai mahasiswa.
                                    <br />
